...
function InfoCard(props) {
  return (
    <div ref={props.infoDiv} id='infoCard' className={` w-full lg:mx-0 p-4 mt-32 mb-[200px] flex flex-col sm:flex-row rounded-2xl bg-color2/80 shadow-[2px_2px_5px_rgba(0,0,0,0.2)]`}>
