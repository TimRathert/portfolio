...
function ProjectCard(props) {
  ...
  return (
        <a href={props.project.link} target="_blank" rel='noreferrer ' className={`snap-start mx-8 p-2 rounded-lg flex flex-col items-center gap-2 bg-color4 text-white w-4/5 lg:w-3/5 min-w-[80%] md:min-w-[60%] lg:min-w-[50%] shadow-[2px_2px_5px_rgba(0,0,0,0.2)]`}>
