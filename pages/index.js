...
export default function Home() {
  ...
  return (
    <div ref={target} className={`flex h-fitcontent justify-center flex-col bg-gradient-to-b from-color5 via-color1/50 via-color2/50 to-color2 text-color2 transition-all duration-700 overflow-hidden`}>
      <Head>
